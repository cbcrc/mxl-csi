...
This folder is an adaptation of the qvest-mxl-k8s-test scenario that uses mxl-k8s-csi for dynamic provisioning of the MXL domain storage used by the workloads.
It is designed to validate both the mxl-k8s-csi driver and the Qvest mxl-k8s operator in the same end-to-end media workflow.
...
- mxl-k8s-csi is installed and its controller and node components are running.
...
- This scenario assumes mxl-k8s operator components and mxl-k8s-csi are already installed and running.
